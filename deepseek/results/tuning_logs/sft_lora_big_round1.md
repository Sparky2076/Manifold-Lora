...
|------:|---:|----------:|------|----------------|-----------:|--------------:|------|
| 314572 | `2e-5` | 2000 | RUN |  |  |  | 修复 `utils_sft.py` 缩进错误后重提 |
| 314573 | `2e-5` | 4000 | RUN |  |  |  | 修复 `utils_sft.py` 缩进错误后重提 |
| 314574 | `2.5e-5` | 2000 | RUN |  |  |  | 修复 `utils_sft.py` 缩进错误后重提 |
| 314575 | `2.5e-5` | 4000 | RUN |  |  |  | 修复 `utils_sft.py` 缩进错误后重提 |
