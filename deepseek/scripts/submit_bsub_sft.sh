...
for v in SFT_PRESET SFT_FORMAT SFT_VAL_RATIO MAX_STEPS EVAL_EVERY BATCH_SIZE GRAD_ACCUM_STEPS MAX_LENGTH LR WEIGHT_DECAY ADAM_BETA1 ADAM_BETA2 LORA_TYPE LORA_R LORA_ALPHA LORA_DROPOUT TORCH_DTYPE CONDA_ROOT CONDA_BASE CONDA_ENV_NAME; do
  eval "export $v=\"\${$v:-}\""
done
